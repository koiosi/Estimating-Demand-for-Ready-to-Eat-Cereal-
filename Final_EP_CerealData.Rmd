...
####QUESTION1 1. **Data Description.** **Provide a brief, non-technical,
...
3.  Instruments and IV estimation. Construct instruments to account for
    price endogeneity and use them to perform IV estimation. Report
...
###QUESTION5 \# Thinking out of the matrix. In case you didn’t get a
